...
const translations = {
  pt: {
    ...
    'hero.profession': 'Desenvolvedor Back-End Python',
    'hero.downloadcv': 'BAIXAR CV',
    'btn.curriculo': 'VER CURRÍCULO',
    'hero.sobre': 'Construo APIs escaláveis e produtos digitais com Python e FastAPI, aplicando arquitetura limpa, autenticação segura e integração com Inteligência Artificial.',
    'hero.disponivel': 'Disponível para estágio, oportunidades CLT e projetos freelance.',
    'sobre.titulo': 'Sobre Mim',
    'btn.conheca': 'CONHEÇA',
    'sobre.desc': 'Desenvolvedor Back-End com foco na construção de APIs robustas utilizando Python e FastAPI. Experiência prática com autenticação JWT, modelagem de banco de dados relacional, integração com APIs de IA e desenvolvimento de aplicações web completas.',
    'sobre.desc2': 'Graduando em Ciências Computacionais, com aprofundamento em algoritmos, estruturas de dados e arquitetura de software. Busco atuar em projetos desafiadores, contribuindo com soluções escaláveis e bem estruturadas.',
    'skills.titulo': 'Stack Técnica',
    'skills.iadados': 'IA & Dados',
  ...
  en: {
    ...
    'hero.profession': 'Python Back-End Developer',
    'hero.downloadcv': 'DOWNLOAD CV',
    'btn.curriculo': 'SEE RESUME',
    'hero.sobre': 'I build scalable APIs and digital products with Python and FastAPI, applying clean architecture, secure authentication, and AI integration.',
    ...
    'sobre.desc': 'Back-End Developer focused on building robust APIs using Python and FastAPI. Hands-on experience with JWT authentication, relational database modeling, AI API integration, and full web application development.',
    'sobre.desc2': 'Undergraduate in Computational Sciences, with a deep focus on algorithms, data structures, and software architecture. I seek to work on challenging projects, contributing with scalable and well-structured solutions.',
    'skills.titulo': 'Tech Stack',
    'skills.iadados': 'AI & Data',
